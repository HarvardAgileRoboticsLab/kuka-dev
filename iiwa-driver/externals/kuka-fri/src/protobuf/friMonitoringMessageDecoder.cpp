...
void MonitoringMessageDecoder::initMessage()
{
   ...
   map_repeatedTransformation(FRI_MANAGER_NANOPB_DECODE,1,
           &m_pMessage->requestedTransformations,
           &m_tSendContainer.m_requestedTransformations);
   
   map_repeatedTransformation(FRI_MANAGER_NANOPB_DECODE,5,
           &m_pMessage->monitorData.subscribedTransformations,
           &m_tSendContainer.m_subscribedTransformations);
}
