...
/** container for repeated transformation elements */
typedef struct repeatedTransformationArguments {
    size_t size;
    size_t max_size;
    Transformation* value;
} tRepeatedTransformationArguments;
...
bool encode_repeatedTransformation(pb_ostream_t *stream, const pb_field_t *field,
        void * const *arg);

bool decode_repeatedInt(pb_istream_t *stream, const pb_field_t *field,
      void **arg);

bool decode_repeatedTransformation(pb_istream_t *stream, const pb_field_t *field,
        void **arg);
...
void map_repeatedTransformation(eNanopbCallbackDirection dir, int numberOfElements,
      pb_callback_t *values, tRepeatedTransformationArguments *arg);
