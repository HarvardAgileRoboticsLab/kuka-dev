...
//******************************************************************************
ClientApplication::ClientApplication(IConnection& connection, TransformationClient& trafoClient)
   : _connection(connection), _robotClient(NULL),_trafoClient(&trafoClient), _data(NULL)
{
   _data = _trafoClient->createData();
}
