...
/* Generated by nanopb-0.2.8 at Mon Mar 14 13:45:58 2016. */
...
const pb_field_t MessageMonitorData_fields[8] = {
    ...
    PB_FIELD2(  7, MESSAGE , REPEATED, CALLBACK, OTHER, MessageMonitorData, subscribedTransformations, externalTorque, &Transformation_fields),
    PB_FIELD2( 15, MESSAGE , OPTIONAL, STATIC  , OTHER, MessageMonitorData, timestamp, subscribedTransformations, &TimeStamp_fields),
    PB_LAST_FIELD
};

const pb_field_t MessageIpoData_fields[6] = {
    PB_FIELD2(  1, MESSAGE , OPTIONAL, STATIC  , FIRST, MessageIpoData, jointPosition, jointPosition, &JointValues_fields),
    PB_FIELD2(  2, MESSAGE , OPTIONAL, STATIC  , OTHER, MessageIpoData, cartesianPosition, jointPosition, &Transformation_fields),
    PB_FIELD2( 10, ENUM    , OPTIONAL, STATIC  , OTHER, MessageIpoData, clientCommandMode, cartesianPosition, 0),
...
const pb_field_t MessageCommandData_fields[5] = {
    ...
    PB_FIELD2(  4, MESSAGE , OPTIONAL, STATIC  , OTHER, MessageCommandData, requestedTransformation, jointTorque, &Transformation_fields),
    PB_LAST_FIELD
};
...
const pb_field_t FRIMonitoringMessage_fields[8] = {
    ...
    PB_FIELD2(  6, MESSAGE , REPEATED, CALLBACK, OTHER, FRIMonitoringMessage, requestedTransformations, ipoData, &Transformation_fields),
