...
typedef struct _MessageCommandData {
    ...
    bool has_requestedTransformation;
...
typedef struct _MessageIpoData {
    bool has_jointPosition;
    JointValues jointPosition;
    bool has_cartesianPosition;
    Transformation cartesianPosition;
...
typedef struct _MessageMonitorData {
    ...
    pb_callback_t subscribedTransformations;
    bool has_timestamp;
    TimeStamp timestamp;
} MessageMonitorData;
...
typedef struct _FRIMonitoringMessage {
    ...
    pb_callback_t requestedTransformations;
    bool has_endOfMessageData;
    MessageEndOf endOfMessageData;
...
#define MessageCommandData_requestedTransformation_tag 4
#define MessageIpoData_jointPosition_tag         1
#define MessageIpoData_cartesianPosition_tag     2
...
#define MessageMonitorData_subscribedTransformations_tag 7
...
extern const pb_field_t MessageIpoData_fields[6];
