...
void CommandMessageEncoder::initMessage()
{
   ...
   m_pMessage->commandData.has_requestedTransformation = false;
   m_pMessage->commandData.requestedTransformation.matrix_count = 0;
   ...
   // clear memory of requested transformation
   memset(&m_pMessage->commandData.requestedTransformation, 0, 
         sizeof(m_pMessage->commandData.requestedTransformation));
}
