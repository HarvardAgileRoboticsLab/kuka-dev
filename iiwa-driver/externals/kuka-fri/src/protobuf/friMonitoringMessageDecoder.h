...
namespace FRI
{
   ...
   private:
      ...
      struct LocalMonitoringDataContainer
      {
         ...
         tRepeatedTransformationArguments m_requestedTransformations;
         tRepeatedTransformationArguments m_subscribedTransformations;
         ...
         LocalMonitoringDataContainer()
         {
            ...
            init_repeatedTransformation(&m_requestedTransformations);
            init_repeatedTransformation(&m_subscribedTransformations);
         }
         ...
         ~LocalMonitoringDataContainer()
         {
            ...
            free_repeatedTransformation(&m_requestedTransformations);
            free_repeatedTransformation(&m_subscribedTransformations);
         }
      };
